...
public class Directory_Person_Adapter extends BaseAdapter {

    private Context activity;
    private LayoutInflater inflater;
    private List<Dir_Person> Tagmodels;
    private List<String> tag_val;

    List<Dir_Person> obj_product;
 public Directory_Person_Adapter(Context activity, List<Dir_Person> Tagmodels) {
        this.activity = activity;
        obj_product = Tagmodels;
        this.Tagmodels=new ArrayList<Dir_Person>();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
       ...
       // if (convertView == null)
            ...
            holder.txt_personaddress=(TextView)convertView.findViewById(R.id.tv_person_address);
             ...
             Dir_Person cat_product=(Dir_Person)getItem(position);
