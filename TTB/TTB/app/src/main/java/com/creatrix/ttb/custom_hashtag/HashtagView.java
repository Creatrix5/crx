...
public class HashtagView extends LinearLayout {
    ...
    private void extractAttributes(AttributeSet attrs) {
        ...
        try {
            ...
            itemTextColor = a.getColor(R.styleable.HashtagView_tagTextColor, Color.RED);
  ...
  private void sort() {
    ...
    private void decorateItemTextView(TextView textView) {
      //  textView.setTextColor(itemTextColor);
            ...
            textView.setTextColor(getResources().getColorStateList(R.color.selected_text_color));
